      ...
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            ...
            <Link
              to="/signup"
              className="font-medium text-emerald-400 hover:text-emerald-300 group"
            >
              Sign up{" "}
              <ArrowRight className="inline h-4 w-4 group-hover:translate-x-1 transition-transform duration-200" />
            </Link>
          </p>
        </div>
      </motion.div>
